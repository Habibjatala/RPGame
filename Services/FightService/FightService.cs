...
namespace FirstTut.Services.FightService
{
    public class FightService: IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
        {
            ...
            try
            {
                ...
                if (opponent is null)
                    throw new Exception("Attacker is not found...");
             
                else if (attacker is null)
                    throw new Exception("Opponent is not found...");
                else if (attacker.Weapon is null)
                    throw new Exception("Weapon is not found ...");
